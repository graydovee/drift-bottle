...
public class Page extends JFrame{
	...
	JPanel jp;
	JLabel jl;
	ImageIcon img1=new ImageIcon("img/page.jpg");
	ImageIcon img2=new ImageIcon("img/pt.png");
	ImageIcon img3=new ImageIcon("img/find.png");
	ImageIcon img4=new ImageIcon("img/all.png");
	...
	public Page(User arg) {
        ...
        JButton co=new JButton(new ImageIcon("img/name.png"));
