...
public class Throw extends JFrame{
	...
	JLabel jl1=new JLabel(new ImageIcon("img/11.png"));
	JLabel jl2=new JLabel(new ImageIcon("img/222.png"));
	JLabel jl3=new JLabel(new ImageIcon("img/333.png"));
	...
	class XinQing extends JDialog{
		...
		public XinQing() {
			...
			m[0]=new ImageIcon("img/happy.jpg");
			m[1]=new ImageIcon("img/sad.jpg");
			m[2]=new ImageIcon("img/other.jpg");
			for(int i=0;i<3;++i) {
